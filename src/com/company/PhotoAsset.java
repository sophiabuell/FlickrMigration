...
public class PhotoAsset {
    ...
    private static JSONObject getLargestPhotoSizeObject(JSONObject photoSizeObject){
    ...
    public boolean download() throws IOException {
        ...
        if (imageFile.exists() && !imageFile.delete()) {
            throw new FileAlreadyExistsException(imageFile.getName());
        }
        if (imageFile.createNewFile()) {
            ...
            throw new IOException("Cannot create file " + imageFile + ". Image not downloaded. ");
        }
        return true;
    }
}
